...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-white font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#f5f4ef] to-[#e8e6df] text-gray-900 p-12 flex-col justify-center relative overflow-hidden border-r border-gray-200">
        <div className="relative z-10 max-w-lg mx-auto">
          ...
          <div className="space-y-8 text-lg text-gray-600">
            <p className="leading-relaxed">
              ...
              <br />
              <span className="text-gray-900 font-bold mt-2 block">Contact us : 03405542097</span>
            </p>
            
            <div className="pt-8 border-t border-gray-300">
              <p className="text-xl font-bold text-gray-900 mb-4">
                Collaborate us and make your business digital
              </p>
              
              <a href="https://wa.me/923405542097" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-3 bg-[#25D366] hover:bg-[#1ebd5c] text-white px-6 py-3 rounded-full font-bold transition-all shadow-lg shadow-[#25D366]/30">
