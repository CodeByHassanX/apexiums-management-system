          ...
          <div className="space-y-8 text-lg text-gray-400">
            ...
            <div className="pt-8 border-t border-gray-700">
              <p className="text-xl font-bold text-white mb-2">
                Collaborate with us and make your business fully digital
              </p>
              
              <div className="flex items-center justify-between mt-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                <p className="text-sm text-gray-400 mr-4">
                  If you are a new user then contact us and book a free demo
                </p>
                <a href="https://wa.me/923405542097" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-12 h-12 bg-[#25D366] hover:bg-[#1ebd5c] text-white rounded-full transition-all shadow-lg shadow-[#25D366]/30 shrink-0">
