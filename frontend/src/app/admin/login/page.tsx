      ...
      <div className="hidden lg:flex lg:w-5/12 bg-[#1b2028] flex-col justify-between p-12 lg:p-16 relative">
        <div className="mt-20">
          <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
            Central HQ<br />Platform Management.
          </h1>
          <p className="text-gray-400 text-lg max-w-md leading-relaxed">
            Monitor all active branches, collect platform fees, and manage global system settings.
          </p>
        </div>
        ...
        <div className="mt-auto">
          <div className="bg-white/5 backdrop-blur-md rounded-xl p-5 inline-block border border-white/10">
            <p className="text-gray-400 text-sm">
              <span className="text-white font-bold text-base mr-2">12 Active</span> 
              stores currently running APEXIUMS
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center bg-white px-4 sm:px-6 lg:px-20 xl:px-32">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="flex items-center space-x-3 mb-10">
            ...
            <span className="text-xl font-bold text-gray-900 tracking-tight">APEXIUMS HQ</span>
          </div>
          ...
          <p className="text-gray-500 text-sm mb-8">
            Enter your master credentials to access the HQ portal.
          </p>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email" required
                  placeholder="super@apexiums.com"
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full flex justify-center items-center space-x-2 py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-[#12b4a3] hover:bg-[#0e9082] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#12b4a3] transition-colors"
              >
