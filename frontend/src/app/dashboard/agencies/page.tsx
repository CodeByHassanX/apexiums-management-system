  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => alert("This feature is currently under development. The backend API is not yet available.")} className="bg-[#12b4a3] hover:bg-[#0e9082] text-white px-4 py-2 rounded-xl font-bold transition flex items-center shadow-lg shadow-[#12b4a3]/20">
