      ...
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#1b2028] shadow-2xl transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:flex md:flex-col ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-6 scrollbar-hide">
          ...
          {(hasPermission('sales.create') || hasPermission('sales.view')) && (
            <div className="space-y-2">
              <div className="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Sales & Orders</div>
          ...
          {(hasPermission('products.view') || hasPermission('inventory.view') || hasPermission('purchases.view')) && (
            <div className="space-y-2">
              <div className="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Inventory</div>
          ...
          {hasPermission('finance.view') && (
            <div className="space-y-2">
              <div className="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Finance</div>
              <NavItem 
